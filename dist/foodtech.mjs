...
var en$1 = {
	"foodtech.entry.name": "FoodTech",
	"foodtech.entry.description": "Description of this extension"
};
var ja$1 = {
	"foodtech.entry.name": "FoodTech",
	"foodtech.entry.description": "拡張機能の説明"
};
var translations$1 = {
	en: en$1,
	ja: ja$1,
	"ja-Hira": {
	"foodtech.entry.name": "FoodTech",
	"foodtech.entry.description": "かくちょうきのうのせつめい"
}
};
...
var en = {
	...
	"foodtech.doIt": "do it [SCRIPT]"
};
var ja = {
	"foodtech.name": "FoodTech",
	"foodtech.doIt": "[SCRIPT] を実行する"
};
var translations = {
	en: en,
	ja: ja,
 ...
 * @type {string}
 */
var extensionURL = 'https://getpa.github.io/xcx-food-tech/dist/foodtech.mjs';
